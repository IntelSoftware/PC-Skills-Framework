...
PCSkillsHello               --- HelloWorld PC Skill Example directory
PCSkillExample            --- Project for the PCSKill Example
PCSkillInstallerExample   --- Project to create the Installer for the HelloWorld PC Skill
PCSkillsRelease	          --- PC Skill Example directory
PCSkillExample            --- Project for the PCSKill Example
PCSkillInstallerExample   --- Project to create the Installer for the PC Skill
